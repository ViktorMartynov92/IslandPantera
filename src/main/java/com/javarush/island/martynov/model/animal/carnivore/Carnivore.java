...
import com.javarush.island.martynov.app.MainIsland;
...
public class Carnivore extends Animal {
    ...
    public void move() {
        ...
        Field[][] island = MainIsland.island;
    ...
    @Override
    public void eat() {
        Field currentField = MainIsland.island[this.position.x][this.position.y];
        Herbivore prey = null;
        ...
        if (prey != null && SimulationConfig.RANDOM.nextDouble() < SimulationConfig.CARNIVORE_SUCCESSFUL_HUNT_PROBABILITY) {
            ...
            this.weight = Math.min(SimulationConfig.CARNIVORE_WEIGHT, this.weight + (int) (prey.getWeight() * 0.5));
